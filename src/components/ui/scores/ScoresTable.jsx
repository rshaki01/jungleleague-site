        ...
        return ( game.status == "completed" && (<div key={game.id} className="flex flex-col gap-3 w- p-5 mb-5 bg-gradient-to-br from-gray-800/50 to-gray-900/30 rounded-xl border border-yellow-400/20 overflow-hidden text-xs font-semibold hover:bg-gray-800/20 transition-all duration-200">
            ...
            <div className="mt-3 border-t border-gray-700 pt-4 space-y-5">
              ...
              <div>
                ...
                <div className="overflow-x-auto rounded-lg border border-gray-700/50">
                  <div className="min-w-[340px]">
                    <div className="grid grid-cols-10 gap-2 text-xs text-gray-400 uppercase tracking-wider px-3 py-2 border-b border-gray-700/60 bg-gray-800/60">
                    ...
                    {game.boxScore[game.homeTeamId].map((player, i) => (
                      ...
                      >
                        <span className="col-span-2 text-gray-200">{player.substitute && <span className="mr-1 text-yellow-400/70">★</span>}#{getPlayerByPlayerId(player.playerId, players).number} - {getPlayerByPlayerId(player.playerId, players).name}{player.substitute && <span className="ml-1 text-yellow-400/70 text-xs">(Sub)</span>}</span>
                        ...
                        <span className="text-center">{player.tpm + player.twoPm}/{player.tpa + player.twoPa}</span>
              ...
              <div>
                ...
                <div className="overflow-x-auto rounded-lg border border-gray-700/50">
                  <div className="min-w-[340px]">
                    <div className="grid grid-cols-10 gap- text-xs text-gray-400 uppercase tracking-wider px-3 py-2 border-b border-gray-700/60 bg-gray-800/60">
                      <span className="col-span-2">Player</span>
                      <span className="text-center">PTS</span>
                      <span className="text-center">REB</span>
                      <span className="text-center">AST</span>
