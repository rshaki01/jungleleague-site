...
export default function ScoresTable({division, week, teamId}) {
  ...
  return (
    <div className="w-full m-auto mt-5">
        ...
        {games.map((game) => (<div key={game.id}  className="flex flex-col gap-3 w- p-5 mb-5 bg-gradient-to-br from-gray-800/50 to-gray-900/30 rounded-xl border border-yellow-400/20 overflow-hidden text-xs font-semibold hover:bg-gray-700/30 transition-all duration-200">
            ...
            <div className="mt-3 border-t border-gray-700 pt-4">
              ...
              <div className="text-sm text-gray-300 mt-4 mb-2 font-bold">
